...
public class TicketController {
    ...
    public Response<ModelResponse<Branch>> createTicket(@Valid @RequestBody Request<TicketRequest> request){
        return null;//new Response<>(new ModelResponse<>(branchService.saveBranch(request.getBody().buildModel())));
    }
