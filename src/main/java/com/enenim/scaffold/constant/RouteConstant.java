...
public interface RouteConstant {
    ...
    String ADMINISTRATION_SETTING_CREATE = ADMINISTRATION + SETTING + CREATE;
    ...
    String ADMINISTRATION_SETTING_DESTROY = ADMINISTRATION + SETTING + DESTROY;
    ...
    //Vendor sub-modules
    String BILLER_SUBMODULE = DOT + "vendor" + DOT;
