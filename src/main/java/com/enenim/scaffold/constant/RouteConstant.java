...
public interface RouteConstant {
    ...
    String USER_VENDOR_SERVICE_CREATE = USER + ".vendor_service."+ CREATE;
    String VENDOR_SERVICE_CATEGORY_INDEX = VENDOR + ".service."+ "category_index";
    String VENDOR_SERVICE_CATEGORY_SHOW = VENDOR + ".service."+ "category_show";
    ...
    //Payment channel sub-modules
    String PAYMENT_CHANNEL = DOT + "payment_channel" + DOT;
    String ADMINISTRATION_PAYMENT_CHANNEL_INDEX = ADMINISTRATION + PAYMENT_CHANNEL + INDEX;
    String ADMINISTRATION_PAYMENT_CHANNEL_CREATE = ADMINISTRATION + PAYMENT_CHANNEL + CREATE;
    String ADMINISTRATION_PAYMENT_CHANNEL_UPDATE= ADMINISTRATION + PAYMENT_CHANNEL + UPDATE;
    String ADMINISTRATION_PAYMENT_CHANNEL_SHOW = ADMINISTRATION + PAYMENT_CHANNEL + SHOW;


    //Account providers sub-modules
    String ACCOUNT_PROVIDER = DOT + "account_provider" + DOT;
    String ADMINISTRATION_ACCOUNT_PROVIDER_INDEX = ADMINISTRATION + ACCOUNT_PROVIDER + INDEX;
    String ADMINISTRATION_ACCOUNT_PROVIDER_CREATE = ADMINISTRATION + ACCOUNT_PROVIDER + CREATE;
    String ADMINISTRATION_ACCOUNT_PROVIDER_UPDATE= ADMINISTRATION + ACCOUNT_PROVIDER + UPDATE;
    String ADMINISTRATION_ACCOUNT_PROVIDER_SHOW = ADMINISTRATION + ACCOUNT_PROVIDER + SHOW;


    //Currencies sub-modules
    ...
    String ADMINISTRATION_CURRENCY_SHOW = ADMINISTRATION + CURRENCY + SHOW;
    ...
    //Feedback sub-modules
    String FEEDBACK = DOT + "feedback" + DOT;
    String ADMINISTRATION_FEEDBACK_INDEX = ADMINISTRATION + FEEDBACK + INDEX;
    String ADMINISTRATION_FEEDBACK_CREATE = ADMINISTRATION + FEEDBACK + CREATE;
    String ADMINISTRATION_FEEDBACK_SERVICE_COMMENT = ADMINISTRATION + FEEDBACK + "service-comment";
    String ADMINISTRATION_FEEDBACK_COMMENTS = ADMINISTRATION + FEEDBACK + "comments";
    String ADMINISTRATION_FEEDBACK_UPDATE= ADMINISTRATION + FEEDBACK + UPDATE;
    String ADMINISTRATION_FEEDBACK_SHOW = ADMINISTRATION + FEEDBACK + SHOW;
    String ADMINISTRATION_CONSUMER_FEEDBACK = ADMINISTRATION + FEEDBACK + "consumer." + INDEX;
    String ADMINISTRATION_CONSUMER_FEEDBACK_SHOW = ADMINISTRATION + FEEDBACK + "consumer." + SHOW;
    ...
    String USER_CONSUMER_FEEDBACK_INDEX = USER + ".consumer_feedback."+ INDEX;
    String USER_CONSUMER_TRANSACTION_INDEX = USER + ".consumer_transaction."+ INDEX;
